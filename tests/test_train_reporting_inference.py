...
class TrainReportingInferenceTests(unittest.TestCase):
    ...
    def test_comparison_markdown_renders_run_rows(self) -> None:
        markdown = comparison_markdown(
            [
                {"run_dir": "outputs/run-a", "architecture": "dense", "parameter_count": 10, "sequence_length": 8, "latest_val_loss": 1.2, "best_val_loss": 1.1, "latest_val_perplexity": 3.3},
                {"run_dir": "outputs/run-b", "architecture": "modular", "parameter_count": 9, "sequence_length": 8, "latest_val_loss": 1.0, "best_val_loss": 0.9, "latest_val_perplexity": 2.7},
            ]
        )
