...
The guiding research direction and active execution path are captured in [ROADMAP-working-memory.md](ROADMAP-working-memory.md).

If you are new to this repository, read this file first, then [ROADMAP-working-memory.md](ROADMAP-working-memory.md).
...
The main documents are [ROADMAP-working-memory.md](ROADMAP-working-memory.md), which defines the active latent CoT roadmap and open work items; [METRICS.md](METRICS.md), which defines the evaluation metrics and their decision weight; and [README.md](README.md), which defines repository purpose and implementation guidance.
