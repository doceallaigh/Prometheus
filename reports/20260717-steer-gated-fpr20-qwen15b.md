...
Model: `Qwen/Qwen2.5-1.5B-Instruct`, dump: `reports/20260715-retrofit-qwen15b-eval.completions.jsonl`, trigger: cusum, steer window: 24 tokens, inject offset: 4 tokens, rollout FPR: 0.2, gate: margin
...
Problems: 200, baseline greedy accuracy: 0.7150, wrong: 57, steer targets: 45 (false alarms: 24, on wrong: 21, no room: 0, mean gate false-alarm/hit: 0.600/0.820)

| alpha | final accuracy | flips up | flips down | reproduced exactly | regen tokens/problem |
| --- | --- | --- | --- | --- | --- |
| 0.0 | **0.7150** | 0 | 0 | 40/45 | 30.2 |
| 2.0 | **0.7150** | 2 | 2 | 6/45 | 29.5 |
| 4.0 | **0.7050** | 1 | 3 | 3/45 | 42.4 |
