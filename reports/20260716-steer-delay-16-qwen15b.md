...
Model: `Qwen/Qwen2.5-1.5B-Instruct`, dump: `reports/20260715-retrofit-qwen15b-eval.completions.jsonl`, trigger: oracle, steer window: 24 tokens, inject offset: 16 tokens
...
Problems: 200, baseline greedy accuracy: 0.7150, wrong: 57, steer targets: 47 (no site: 9, no room: 1)

| alpha | final accuracy | flips up | flips down | reproduced exactly | regen tokens/problem |
| --- | --- | --- | --- | --- | --- |
| 4.0 | **0.7200** | 1 | 0 | 0/47 | 45.0 |
