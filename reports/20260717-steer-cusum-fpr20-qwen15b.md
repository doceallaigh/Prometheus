...
Problems: 200, baseline greedy accuracy: 0.7150, wrong: 57, steer targets: 45 (false alarms: 24, on wrong: 21, no room: 0)

| alpha | final accuracy | flips up | flips down | reproduced exactly | regen tokens/problem |
| --- | --- | --- | --- | --- | --- |
| 0.0 | **0.7150** | 0 | 0 | 40/45 | 30.2 |
| 2.0 | **0.7000** | 3 | 6 | 1/45 | 28.7 |
| 4.0 | **0.7000** | 1 | 4 | 0/45 | 34.1 |
