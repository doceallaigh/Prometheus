...
Model: `Qwen/Qwen2.5-1.5B-Instruct`, dump: `reports/20260715-retrofit-qwen15b-eval.completions.jsonl`, trigger: oracle, steer window: 24 tokens, inject offset: 4 tokens
...
Problems: 200, baseline greedy accuracy: 0.7150, wrong: 57, steer targets: 48 (no site: 9, no room: 0)

| alpha | final accuracy | flips up | flips down | reproduced exactly | regen tokens/problem |
| --- | --- | --- | --- | --- | --- |
| 0.0 | **0.7150** | 0 | 0 | 42/48 | 36.6 |
| 1.0 | **0.7200** | 1 | 0 | 9/48 | 36.2 |
| 2.0 | **0.7300** | 3 | 0 | 0/48 | 43.2 |
| 4.0 | **0.7350** | 4 | 0 | 0/48 | 51.2 |
